...
public class XListView extends ListView implements OnScrollListener {
	...
	private void initWithContext(Context context) {
		...
		mFooterView.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
			@Override
			public void onGlobalLayout() {
				LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) mFooterViewContent.getLayoutParams();
				mFooterViewBottom = lp.bottomMargin;
				getViewTreeObserver().removeGlobalOnLayoutListener(this);
			}
		});
